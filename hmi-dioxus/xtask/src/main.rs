...
//! files the crate ships, and writes them into `hmi-dioxus/assets/vendor/`,
...
fn vendor_dir() -> PathBuf {
    // CARGO_MANIFEST_DIR = .../hmi-dioxus/xtask; the vendored assets live one
    // level up in the crate root, so cwd does not matter.
